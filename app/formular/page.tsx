  ...
  return (
    <EditablePageShell cms={cms} isAdmin={isAdmin} mainClassName="min-h-screen bg-transparent pt-28 pb-24">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <LiveResizableBox boxKey="formPage.intro.box" initialStyle={resolveLiveBoxStyle(liveEditor, 'formPage.intro.box')} isAdmin={isAdmin} className={`section-shell content-box text-center sm:p-10 lg:p-12 ${isAdmin ? 'mt-10' : ''}`}>
          <LiveResizableBox boxKey="formPage.title.box" initialStyle={resolveLiveBoxStyle(liveEditor, 'formPage.title.box')} isAdmin={isAdmin} className="mx-auto max-w-[24rem] text-center">
