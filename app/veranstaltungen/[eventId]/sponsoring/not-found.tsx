export default function EventSponsoringNotFound() {
  return (
    <main className="min-h-screen bg-transparent px-4 py-16 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-3xl rounded-[1.9rem] border border-[color:var(--color-border)]/80 bg-[linear-gradient(180deg,rgba(18,12,9,0.86)_0%,rgba(10,7,5,0.76)_100%)] p-8 shadow-[0_24px_60px_rgba(0,0,0,0.28)]">
        ...
        <p className="mt-4 max-w-2xl text-base leading-8 text-[color:var(--color-muted)]">
          Fuer diese Veranstaltung sind aktuell keine veroeffentlichten Sponsoringangebote verfuegbar oder die Daten werden noch vorbereitet.
        </p>
        <div className="mt-8 flex flex-wrap gap-3">
          ...
          <a href="." className="inline-flex items-center rounded-xl border border-[color:var(--color-accent)]/50 bg-black/15 px-4 py-2 text-sm font-semibold text-[color:var(--color-accent-soft)] transition hover:border-[color:var(--color-accent)] hover:text-white">
            Erneut laden
          </a>
        </div>
      </div>
